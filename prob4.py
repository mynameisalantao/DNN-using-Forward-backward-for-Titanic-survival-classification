...
## 刪除某個feature
delete_column=2                                                                 # 要刪除第幾行
total_data=np.delete(total_data, delete_column, 1)   
...
# 初始化Weight網路
w2=np.random.uniform(-1/math.sqrt(6-1),1/math.sqrt(6-1),(x1_length,x2_length))  # 隨機生成uniform的5*3矩陣
