...
# 初始化Weight網路
w2=np.random.uniform(-1/math.sqrt(6),1/math.sqrt(6),(x1_length,x2_length))      # 隨機生成uniform的6*6矩陣
w3=np.random.uniform(-1/math.sqrt(6),1/math.sqrt(6),(x2_length,x3_length))      # 隨機生成uniform的6*4矩陣
w4=np.random.uniform(-1/math.sqrt(4),1/math.sqrt(4),(x3_length,y_length))       # 隨機生成uniform的4*2矩陣 

# 初始化Bias網路
b2=np.random.uniform(-1/math.sqrt(6),1/math.sqrt(6),(1,x2_length))              # 隨機生成uniform的1*6矩陣
b3=np.random.uniform(-1/math.sqrt(4),1/math.sqrt(4),(1,x3_length))              # 隨機生成uniform的1*4矩陣
...
for epoch in range(0,3000):
    ...
    for batch_number in range(0,batch_num):
        ...
        learn=(1-epoch/3000)*learning_rate+(epoch/3000)*learning_rate_last
        
        w2=w2-learn *average_partial_E_partial_w2
        w3=w3-learn *average_partial_E_partial_w3
        w4=w4-learn *average_partial_E_partial_w4
        
        b2=b2-learn *average_partial_E_partial_b2
        b3=b3-learn *average_partial_E_partial_b3
        b4=b4-learn *average_partial_E_partial_b4
